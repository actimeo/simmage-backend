...
$base->portal->mainmenu_add($token, $mseCI, "Menu CI1", 'Un titre', 'group', null, null);

$base->portal->mainmenu_add($token, $mseCII, "Menu CII1", 'Un titre', 'group', null, null);
$base->portal->mainmenu_add($token, $mseCII, "Menu CII2", 'Un titre', 'group', null, null);

$base->portal->mainmenu_add($token, $mseCIII, "Menu CIII1", 'Un titre', 'group', null, null);
$base->portal->mainmenu_add($token, $mseCIII, "Menu CIII2", 'Un titre', 'group', null, null);
$base->portal->mainmenu_add($token, $mseCIII, "Menu CIII3", 'Un titre', 'group', null, null);
