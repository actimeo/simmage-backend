...
class portalJsonTest extends PHPUnit_Framework_TestCase {
  ...
  public function testPortalJson() {
    ...
    $mme_idA1 = self::$base->portal->mainmenu_add($this->token, $mse_idA, $mme_nameA1, null, null);

    $mme_nameA2 = 'main menu A.2';
    $mme_idA2 = self::$base->portal->mainmenu_add($this->token, $mse_idA, $mme_nameA2, null, null);
